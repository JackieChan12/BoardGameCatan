...
namespace Board.NumberOverField
{
    ...
    public class NumberOverField : MonoBehaviour
    {
        ...
        public void SetNumberValue(int value)
        {
            ...
            numberOverField = GetComponentInChildren<TextMeshProUGUI>(true);

            if (numberOverField == null) return;
        ...
        {
            numberOverField = GetComponentInChildren<TextMeshProUGUI>(true);
            if (numberOverField != null)
            {
                numberOverField.gameObject.SetActive(false);
            }
        }
        ...
        public void ShowNumber()
        {
            ...
            if (numberOverField != null)
            {
                numberOverField.gameObject.SetActive(true);
            }
        }
    }
}