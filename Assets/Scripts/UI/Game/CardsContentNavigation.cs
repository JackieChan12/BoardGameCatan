...
namespace UI.Game
{
    public class CardsContentNavigation : MonoBehaviour
    {
        ...
        {
            if (knightCardButton != null) knightCardButton.interactable = false;
            if (roadBuildCardButton != null) roadBuildCardButton.interactable = false;
            if (inventionCardButton != null) inventionCardButton.interactable = false;
            if (monopolCardButton != null) monopolCardButton.interactable = false;
            if (useCardButton != null) useCardButton.interactable = false;
        }
        ...
        {
            var currentPlayerCards = GameManager.State.Players[playerId].properties.cards;
            var currentPlayerBlockedCards = 
                GameManager.State.Players[playerId].properties.cards.CheckIfMarkAsBlocked();
        ...
        private void ChooseCardButton(Cards.CardType type)
        {
            ...
            if (!GameManager.CardsManager.CheckIfCurrentPlayerCanUseCard(type, playerId) || 
        ...
        private void OnCardUseButtonClick()
        {
            ...
            GameManager.State.Players[playerId].UseCard(cardChosen);
