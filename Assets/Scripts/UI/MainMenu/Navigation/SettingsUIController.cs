...
namespace UI.MainMenu.Navigation
{
    public class SettingsUIController : MonoBehaviour
    {
        ...
        void Start()
        {
            // Translate fullscreen dropdown options programmatically to Vietnamese
            for (var i = 0; i < fullscreenDropdown.options.Count; i++)
            {
                if (fullscreenDropdown.options[i].text == "PEŁNY EKRAN")
                {
                    fullscreenDropdown.options[i].text = "TOÀN MÀN HÌNH";
                }
                else if (fullscreenDropdown.options[i].text == "OKNO")
                {
                    fullscreenDropdown.options[i].text = "CỬA SỔ";
                }
            }
        ...
        private void OnDefaultButton()
        {
            ...
            fullscreenDropdown.value = 
                fullscreenDropdown.options.FindIndex(option => option.text == ("TOÀN MÀN HÌNH"));
        ...
        {
            var isFullScreen = 
                fullscreenDropdown.options[fullscreenDropdown.value].text == "TOÀN MÀN HÌNH";
        ...
        private void UpdateLabels()
        {
            ...
            fullscreenDropdown.value = 
                fullscreenDropdown.options.FindIndex(
                    option => option.text == (Screen.fullScreen ? "TOÀN MÀN HÌNH" : "CỬA SỔ"));
        }
    }
}
