...
namespace UI.MainMenu.Navigation
{
    ...
    public class MainMenuNavigation : MonoBehaviour
    {
        ...
        {
            // Set up GameManager and start the game directly, bypassing the player names/colors screen
            SetUpGameManager();
        ...
        private bool SetUpGameManager()
        {
            ...
            for (var i = 0; i < GameManager.State.Players.Length; i++)
            {
                ...
                {
                    badNickErrorLabel.text = "Người chơi " + (i + 1) + " chưa chọn màu sắc!";
                    return false;
                }
                ...
                if (playerNamesInputs[i].text == "")
                {
                    GameManager.State.Players[i] = new Player.Player(
                        i, "Người chơi " + (i+1), availableColors[playersColorsIndexes[i]]);
                    continue;
                }
                ...
                {
                    badNickErrorLabel.text = "Tên người chơi " + (i + 1) + " quá ngắn!";
                    return false;
                }
